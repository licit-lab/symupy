...
full_name = (
    "/Users/ladino/Documents/01-Platforms/01-Symuvia/05-SymuViaModPos/darwin/libSymuVia.dylib"
)
print(full_name)
...
for s in time:
    ...
    nVoie = c_int(1)
    dbTime = c_double(0.2)
    nIdVeh = symuvialib.SymCreateVehicleEx(
        stype, sOrigin.encode("UTF8"), sDestination.encode("UTF8"), nVoie, dbTime
    )
