...
from PyQt5.QtWidgets import QWidget, QHBoxLayout, QDialog, QGridLayout, QLabel, QVBoxLayout, QPushButton
...
class NetworkWidget(QWidget):
    ...
    def _plot_network(self):
        self.renderer = NetworkRenderer(self.network, self.mpl_widget.figure, callbackpicking=self._showlink)
